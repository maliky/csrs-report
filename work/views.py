...
@login_required
def react_app(request: HttpRequest, route: str = "") -> HttpResponse:
    """Serve the progressively adopted React shell under a stable sub-route."""
    return render(request, "react/app.html", {"react_route": route})
