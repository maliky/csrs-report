...
export const profileFixture: UserProfile = {
  ...
  position: sessionFixture.user.position,
  login_alias: sessionFixture.user.login_alias,
  email: "aissata.kone@example.test",
  first_name: "Aïssata",
  last_name: "Koné",
  ...
  nodes: [
    {
      employee: {
        ...
        position: "Directrice administrative et financière",
        login_alias: "daf",
        email: "direction.administrative@example.test",
        first_name: "Direction",
        last_name: "Administrative",
        phone: "+225 02 02 02 02 02",
        terms_of_reference: "Superviser le suivi budgétaire et valider les priorités de l'année.",
      },
      task_count: 0,
      children: [
        {
          employee: {
            ...
            email: "awa.finances@example.test",
            first_name: "Awa",
            last_name: "Finances",
            phone: "+225 03 03 03 03 03",
            terms_of_reference: "Piloter les arbitrages opérationnels avec le reporting financier.",
          },
          task_count: 2,
          children: [
            {
              employee: {
                ...
                email: "bamba.comptable@example.test",
                first_name: "Bamba",
                last_name: "Comptable",
                phone: "",
                terms_of_reference: "",
    ...
    },
    {
      employee: {
        ...
        position: "Directeur de la valorisation",
        login_alias: "drv",
        email: "direction.valorisation@example.test",
        first_name: "Direction",
        last_name: "Valorisation",
        phone: "+225 04 04 04 04 04",
        terms_of_reference: "Animer le portefeuille de valorisation des résultats.",
      },
      task_count: 1,
      children: [],
    },
    {
      employee: {
        ...
        email: "controle.interne@example.test",
        first_name: "Contrôle",
        last_name: "Interne",
        phone: "+225 05 05 05 05 05",
        terms_of_reference: "Conduire les audits de conformité sur les process métiers.",
      },
      task_count: 0,
      children: [],
    },
