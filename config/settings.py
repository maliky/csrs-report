...
MIDDLEWARE = [
    ...
    "config.middleware.FrenchAdminLocaleMiddleware",
    "django.middleware.common.CommonMiddleware",
    "django.middleware.csrf.CsrfViewMiddleware",
    "django.contrib.auth.middleware.AuthenticationMiddleware",
    "access.middleware.RoleSimulationMiddleware",
...
PROCESS_DOCUMENT_ROOT = Path(os.environ.get("PROCESS_DOCUMENT_ROOT", "/private-media"))
...
MICROSOFT_GRAPH_FOLDER = os.environ.get("MICROSOFT_GRAPH_FOLDER", "CSRS-Report")
